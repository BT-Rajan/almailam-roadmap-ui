export default {
  ...
  reportPage: {
    ...
    photos: 'الصور',
    photosNeedSavedReport: 'يرجى حفظ التقرير أولاً لإرفاق الصور.',
    addPhoto: 'إضافة',
    removePhoto: 'إزالة الصورة',
    photoLimitReached: 'تم الوصول إلى الحد الأقصى وهو 5 صور.',
    photoStampNotice: 'يتم طباعة اسمك والمشروع وتاريخ/وقت الالتقاط على كل صورة تلقائياً.',
    photoUploadFailedTitle: 'تعذّر رفع الصورة',
    photoRemoveFailedTitle: 'تعذّرت إزالة الصورة',
