export default {
  ...
  emailTemplates: {
    ...
    keys: {
      ...
      contractOtp: {
        label: 'العقد: رمز التحقق',
        description: 'تُرسل عندما يطلب الموظفون من العميل توقيع عقد نهائي.',
      },
      contractSigned: {
      ...
      handoverOtp: {
        label: 'التسليم: رمز التحقق',
        description: 'تُرسل عند اكتمال المشروع وتسوية كامل المستحقات -- وتتضمن قائمة التسليم والرمز.',
      },
