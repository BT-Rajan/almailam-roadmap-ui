export default {
  ...
  overviewTab: {
    ...
    permitNotSetUp: 'لم يتم إعداده للطلبات بعد — يمكن للمسؤول إعداده من الإدارة > كتالوج التصاريح.',
    failedToStartApplication: 'تعذر بدء الطلب',
    ...
    handover: {
      ...
      noEditPermission: 'دورك لا يتيح تعديل المشاريع، لذا لا يمكن تأكيد التسليم إلا من قِبل مستخدم لديه صلاحية التعديل على المشاريع.',
  ...
  quotationTab: {
    ...
    createFirstQuotation: 'أنشئ أول عرض سعر لهذا المشروع.',
    noQuotationSelectedDescription: 'اختر عرض سعر لمعاينته.',
    ...
    quotationAlreadyApprovedTitle: 'يوجد بالفعل عرض سعر نشط',
    quotationAlreadyApprovedDescription: 'يحتوي هذا المشروع بالفعل على عرض سعر بحالة مسودة أو معتمد — إنشاء عرض آخر سينافسه فقط.',
  ...
  newWizard: {
    ...
    projectCreatedMessagePart2: 'للعميل م/',
  ...
  newContractDialog: {
    ...
    clauseTitleRequired: 'عنوان البند مطلوب.',
    clauseContentPlaceholder: 'محتوى البند',
    clauseContentRequired: 'محتوى البند مطلوب.',
  ...
  newQuotationDialog: {
    ...
    columnSerialNo: 'م',
    columnLineItem: 'وصف الخدمة',
    columnQty: 'الوحدات',
    columnRate: 'سعر الوحدة',
    columnAmount: 'المبلغ',
  ...
  servicePickerDialog: {
    ...
    supervisionDatesMissing: 'كل نشاط إشراف محدد يحتاج إلى تاريخ بدء وتاريخ انتهاء خاصين به.',
  ...
  handoverPaymentTab: {
    noEditPermission: 'دورك لا يتيح تعديل المشاريع. اطلب من مستخدم لديه صلاحية التعديل على المشاريع تأكيد الدفع أو التراجع عنه.',
    financeRestricted: 'تُعرض أرقام الدفع فقط للأدوار التي لديها صلاحية الشؤون المالية.',
  ...
  handoverNotesTab: {
    noEditPermission: 'دورك لا يتيح تعديل المشاريع، لذا هذه الملاحظات للقراءة فقط.',
