export default {
  ...
  messageCentrePage: {
    ...
    columnAttachments: 'المرفقات',
    columnSent: 'تاريخ الإرسال',
    composeMessage: 'إنشاء رسالة',
    composeEmailTitle: 'إنشاء بريد إلكتروني',
    channel: 'القناة',
    ...
    noAttachmentsAdded: 'لا توجد ملفات مرفقة',
    removeAttachment: 'إزالة {name}',
    noEmailOnFile: 'لا يوجد بريد إلكتروني مسجل لهذا العميل.',
    message: 'الرسالة',
