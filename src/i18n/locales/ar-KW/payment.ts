export default {
  ...
  statusPanel: {
    ...
    sourceQuotation: 'عرض السعر المصدر',
    contractNo: 'العقد',
    monthlyBillTitle: 'فاتورة {month}',
    monthlyBillFinal: 'نهائية',
    monthlyBillProvisional: 'مبدئية',
    monthlyBillMixedCurrency: 'هذه البنود تُحصّل بعملات مختلفة، لذا تُعرض كل منها بشكل منفصل بدلاً من دمجها.',
    monthlyBillPendingFinalization: 'الخطة لم تُعتمد بعد',
    monthlyBillTotal: 'إجمالي المستحق',
    monthlyBillReceived: 'المستلم',
    monthlyBillOutstanding: 'المتبقي',
  ...
  agreementFormDialog: {
    ...
    columnPercent: '% من العقد',
    columnDueDate: 'تاريخ الاستحقاق',
    columnAmount: 'المبلغ',
    removeInstallment: 'حذف القسط {number}',
    installmentPlaceholder: 'مثال: عند التوقيع',
    milestoneTotal: 'إجمالي الأقساط',
