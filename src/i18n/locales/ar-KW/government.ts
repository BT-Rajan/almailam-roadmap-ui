export default {
  ...
  workspacePage: {
    ...
    submissionRecordedTitle: 'تم تسجيل التقديم',
    submissionRecordedDescription: 'تم وضع علامة على {submissionNo} كمُقدَّم.',
    followUpRecordedTitle: 'تم تسجيل المتابعة',
    followUpRecordedDescription: 'تم تسجيل المتابعة.',
    unableToRecordFollowUp: 'تعذّر تسجيل المتابعة',
    responseRecordedTitle: 'تم تسجيل الرد',
    responseRecordedDescription: 'تم تسجيل رد الجهة الحكومية.',
    submissionCompleteTitle: 'اكتمل التقديم',
    submissionCompleteDescription: 'تم وضع علامة على {submissionNo} كمُعتمد.',
    unableToMarkComplete: 'تعذّر وضع علامة مكتمل',
    submissionWithdrawnTitle: 'تم سحب التقديم',
    submissionWithdrawnDescription: 'تم سحب {submissionNo}.',
    unableToWithdraw: 'تعذّر السحب',
    movedToDraftTitle: 'تمت الإعادة إلى المسودة',
    movedToDraftDescription: 'يمكن الآن تحديث مستندات {submissionNo}.',
    unableToMoveToDraft: 'تعذّرت الإعادة إلى المسودة',
  },
