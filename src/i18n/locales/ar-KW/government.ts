export default {
  ...
  submissionsPage: {
    ...
    submissionUpdatedTitle: 'تم تحديث الطلب',
    submissionUpdatedDescription: 'تم تحديث {no}.',
    failedToUpdateSubmission: 'فشل تحديث الطلب',
    submissionDeletedTitle: 'تم حذف الطلب',
    submissionDeletedDescription: 'تم حذف {no}.',
    failedToDeleteSubmission: 'فشل حذف الطلب',
    editSubmission: 'تعديل الطلب {no}',
    deleteSubmission: 'حذف الطلب {no}',
  ...
  workspacePage: {
    ...
    neverTracked: 'تم إغلاق هذا الطلب قبل مرحلة المتابعة، لذا لا توجد متابعات لعرضها.',
    ...
    followUpDocumentHint: 'أرفق مستندًا إذا طلبته الجهة، أو نسخة محدّثة من مستند سبق إرساله.',
    deleteApplication: 'حذف',
    deleteConfirmTitle: 'حذف {no}؟',
    deleteConfirmMessage: 'ستتم إزالة طلب التصريح هذا وقائمة مستنداته ومتابعاته من المشروع ومن طلبات التصاريح.',
    deleteConfirmMessageFiled: 'تم تقديمه بالفعل إلى الجهة. للاحتفاظ بالسجل، أغلقه كـ «مسحوب» بدلاً من حذفه.',
    ...
    followUpLog: 'المتابعات',
    recordFollowUp: 'تسجيل متابعة',
    noFollowUpsRecorded: 'لا توجد متابعة مسجلة بعد.',
    followUpAt: '{date} الساعة {time}',
    loggedBy: 'سجّلها {name}',
    refresh: 'تحديث',
    followUpDialogDescription: 'سجّل مكالمة أو زيارة تمت مع الجهة لمتابعة {submissionNo}.',
    followUpDate: 'تاريخ المتابعة',
    followUpTime: 'وقت المتابعة',
    followUpContactPerson: 'الشخص الذي تابع مع الجهة الحكومية',
    ...
    saveFollowUp: 'حفظ',
    followUpRecordedTitle: 'تم تسجيل المتابعة',
    followUpRecordedDescription: 'تم حفظ المتابعة.',
    ...
    authorityResponse: 'رد الجهة',
    authorityResponseOptional: 'رد الجهة (اختياري)',
    authorityResponseHint: 'أرفق رد الجهة — التصريح أو كتاب الموافقة أو الرفض أو إشعار القرار.',
    noAuthorityResponse: 'لم يتم رفع رد من الجهة.',
    fileSelected: 'الملف المحدد: {name}',

    uploadedFilesTitle: 'الملفات المرفوعة',
    noFilesUploaded: 'لم يتم رفع أي ملفات لهذا الطلب بعد.',
    acknowledgementFileLabel: 'إشعار استلام الطلب',
    followUpFileLabel: 'مستند المتابعة',
  ...
  newSubmissionDialog: {
    ...
    editTitle: 'تعديل طلب التصريح',
    backToApplication: 'العودة إلى الطلب',
    saveChanges: 'حفظ التغييرات',
    authorityFormLockedHint: 'لا يمكن تغيير الجهة والنموذج إلا أثناء مرحلة التحضير وقبل رفع أي مستند مطلوب.',
    closedTitle: 'هذا الطلب مغلق',
    closedDescription: 'طلب التصريح المغلق سجل منتهٍ ولا يمكن تعديله بعد الآن.',
  },
