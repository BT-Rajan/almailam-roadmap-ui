export default {
  ...
  overviewTab: {
    ...
    permitNotSetUp: 'Not set up for applications yet — an administrator can configure it in Administration > Permit Catalog.',
    failedToStartApplication: 'Could not start the application',
  ...
  quotationTab: {
    ...
    createFirstQuotation: 'Create the first quotation for this project.',
    noQuotationSelectedDescription: 'Select a quotation to preview it.',
    ...
    quotationAlreadyApprovedTitle: 'A quotation is already active',
    quotationAlreadyApprovedDescription: 'This project already has a Draft or Approved quotation -- creating another would just compete with it.',
  ...
  newWizard: {
    ...
    projectCreatedMessagePart2: 'for M/s',
  ...
  newContractDialog: {
    ...
    clauseTitleRequired: 'Clause title is required.',
    clauseContentPlaceholder: 'Clause content',
    clauseContentRequired: 'Clause content is required.',
  ...
  newQuotationDialog: {
    ...
    columnSerialNo: 'S.No',
    columnLineItem: 'Service Description',
    columnQty: 'Units',
    columnRate: 'Unit Rate',
    columnAmount: 'Amount',
