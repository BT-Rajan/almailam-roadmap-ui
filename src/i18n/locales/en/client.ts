export default {
  ...
  contactAddressStep: {
    ...
    addressDescriptionOrganisation: "Add this Client's Registered Address",
  ...
  newWizard: {
    ...
    clientSubmittedMessageOrganisation: 'Organization Client M/S {name} created successfully.',
