export default {
  ...
  auditLogPage: {
    ...
    entityScheduledReports: 'Scheduled Reports',
  ...
  documentTemplates: {
    ...
    layout: 'Letterhead & layout',
    layoutDialogTitle: 'Letterhead & Page Layout',
    letterhead: 'Letterhead background',
    letterheadHint:
      'A PNG/JPEG of the printed stationery (logo, header, footer). Composited full-bleed behind every page so the merged document looks like it was printed directly onto this paper.',
    letterheadUploadHint: 'PNG or JPEG',
    removeBackground: 'Remove background',
    backgroundUploadedTitle: 'Background updated',
    backgroundUploadedDescription: 'The letterhead background was uploaded.',
    ...
    layoutSavedDescription: 'Orientation and margins were updated.',
  },
  ...
  scheduledReportsPage: {
    ...
    pageSubtitle: 'Automatically email a PDF report to one or more people, once or on a repeating schedule.',
    addSchedule: 'New Schedule',
    backToSchedules: 'Back to Scheduled Reports',
    scheduleNotFoundTitle: 'Schedule not found',
    scheduleNotFoundDescription: 'This scheduled report may have been removed or the link is incorrect.',
    columnName: 'Name',
    columnReport: 'Report',
    ...
    noSchedulesFound: 'No scheduled reports yet',
    noSchedulesFoundDescription: "Create one to automatically email a PDF report on a schedule.",
    active: 'Active',
    paused: 'Paused',
    lastRunSent: 'Sent',
    ...
    reportTypeBusinessSummary: 'Business Summary',
    reportTypeFinancialSummary: 'Financial Summary',
    reportTypeProjectStatus: 'Project Status',
    ...
    createDialogTitle: 'New Scheduled Report',
    editDialogTitle: 'Edit Scheduled Report',
    sectionBasics: 'Report',
    name: 'Schedule Name',
    namePlaceholder: 'e.g. Weekly Financial Summary for Management',
    ...
    messageBody: 'Message',
    messageBodyPlaceholder: 'Leave blank for the default message',

    sectionSchedule: 'Schedule',
    frequency: 'Frequency',
    sendDate: 'Send Date',
    sendTimeLabel: 'Send Time',
    sendTimeRequired: 'Send time is required.',
    dayOfWeek: 'Day of Week',
    dayOfMonth: 'Day of Month',
    startDate: 'Start Date',
    startDateRequired: 'Start date is required.',
    endDate: 'End Date',
    endDateHint: 'Leave blank for no end date -- the schedule keeps running indefinitely.',
    isActive: 'Active',
    isActiveHint: 'Turn off to pause this schedule without deleting it.',

    save: 'Save Schedule',
    sendTestNow: 'Send Test Now',
    testSentTitle: 'Test email sent',
    testSentDescription: "A test copy of '{name}' was just emailed to its recipients.",
    testFailedTitle: 'Test send failed',
    scheduleSavedTitle: 'Scheduled report saved',
    scheduleSavedDescription: "'{name}' has been saved.",
    saveFailedTitle: 'Unable to save',
    deleteSchedule: 'Delete Schedule',
    deleteScheduleConfirmMessage: "Delete the scheduled report '{name}'? This can't be undone.",
    scheduleDeletedTitle: 'Scheduled report deleted',
    scheduleDeletedDescription: "'{name}' was deleted.",
