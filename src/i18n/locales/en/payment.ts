export default {
  ...
  statusPanel: {
    ...
    sourceQuotation: 'Source Quotation',
    contractNo: 'Contract',
    monthlyBillTitle: "{month}'s Bill",
    monthlyBillFinal: 'Final',
    monthlyBillProvisional: 'Provisional',
    monthlyBillMixedCurrency: 'These streams bill in different currencies, so they are shown separately rather than combined.',
    monthlyBillPendingFinalization: 'plan not yet finalized',
    monthlyBillTotal: 'Total Due',
    monthlyBillReceived: 'Received',
    monthlyBillOutstanding: 'Outstanding',
