export default {
  ...
  reportPage: {
    ...
    photos: 'Photos',
    photosNeedSavedReport: 'Save the report first to attach photos.',
    addPhoto: 'Add',
    removePhoto: 'Remove photo',
    photoLimitReached: 'Maximum of 5 photos reached.',
    photoStampNotice: 'Your name, the project, and the date/time are printed on each photo automatically.',
    photoUploadFailedTitle: "Couldn't upload photo",
    photoRemoveFailedTitle: "Couldn't remove photo",
