export default {
  ...
  workspacePage: {
    ...
    submissionRecordedTitle: 'Submission recorded',
    submissionRecordedDescription: '{submissionNo} has been marked as Submitted.',
    followUpRecordedTitle: 'Follow-up recorded',
    followUpRecordedDescription: 'The follow-up has been logged.',
    unableToRecordFollowUp: 'Unable to record follow-up',
    responseRecordedTitle: 'Response recorded',
    responseRecordedDescription: "The government's response has been logged.",
    submissionCompleteTitle: 'Submission complete',
    submissionCompleteDescription: '{submissionNo} has been marked Approved.',
    unableToMarkComplete: 'Unable to mark complete',
    submissionWithdrawnTitle: 'Submission withdrawn',
    submissionWithdrawnDescription: '{submissionNo} has been withdrawn.',
    unableToWithdraw: 'Unable to withdraw',
    movedToDraftTitle: 'Moved to Draft',
    movedToDraftDescription: '{submissionNo} can now have its documents updated.',
    unableToMoveToDraft: 'Unable to move to Draft',
  },
