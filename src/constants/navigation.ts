...
// Government Center and Knowledge Base are hidden here deliberately, not
// removed -- their routes/pages/data stay fully intact (still directly
// reachable by URL, and reusable later), just no longer offered as a
// top-level destination. Government Center's own workflow sent staff
// out of a project (Stage 5, Approvals & Permits) into a standalone
// section with no way back to the project they came from; document
// prep is moving into the project workflow itself instead of living
// here. Re-add the entries below to restore both to the sidebar.
