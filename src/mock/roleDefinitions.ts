...
export const ROLE_DEFINITIONS: RoleDefinition[] = [
  {
    ...
    permissions: [
      ...
      { module: 'Finance', view: true, edit: true, delete: true },
  ...
  },
  {
    ...
    description:
      'Manages project delivery, documents, government submissions, financial agreements, and reporting.',
    permissions: [
      ...
      { module: 'Finance', view: true, edit: true, delete: false },
  ...
  },
  {
    role: 'Engineer',
    description:
      'Works on assigned projects and documents, with read access to government tracking and financial status.',
    permissions: [
      { module: 'Projects', view: true, edit: true, delete: false },
      { module: 'Documents', view: true, edit: true, delete: false },
      { module: 'Government', view: true, edit: false, delete: false },
      { module: 'Finance', view: true, edit: false, delete: false },
  ...
  },
  {
    ...
    permissions: [
      ...
      { module: 'Documents', view: true, edit: true, delete: true },
      { module: 'Government', view: true, edit: false, delete: false },
      { module: 'Finance', view: false, edit: false, delete: false },
