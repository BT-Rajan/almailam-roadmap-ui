...
export const CONTRACT_AI_SUMMARIES: ContractAISummary[] = [
  {
    ...
    summary:
      'Active MEP consultancy agreement worth KWD 10,867.5 with standard three-installment payment terms and a 12-week delivery window.',
    details:
  ...
  },
  {
    ...
    summary:
      'Signed architectural renovation agreement worth KWD 14,962.5, excluding interior fit-out execution, with IP rights retained until full payment.',
    details:
  ...
  },
  {
    ...
    summary:
      'Expired handover consultancy contract worth KWD 6,400, closed out across three revisions before signature.',
    details:
