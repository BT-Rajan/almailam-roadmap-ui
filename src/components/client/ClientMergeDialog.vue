    ...
    <div class="flex flex-col gap-4">
      ...
      <div class="grid grid-cols-1 gap-3 tablet:grid-cols-2" role="radiogroup" :aria-label="t('client.mergeDialog.whichRecordToKeep')">
        <button
          ...
          class="flex flex-col gap-2 rounded-lg border p-4 text-start transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-500"
