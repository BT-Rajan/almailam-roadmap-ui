...
export type DashboardTabKey = 'clients' | 'projects' | 'deadlines' | 'financials'
...
// Same WAI-ARIA tabs keyboard pattern as CatalogTabs.vue/ClientWorkspaceTabs.vue --
// arrow keys move focus and activate the newly-focused tab, wrapping at either end.
...
// Right/Left Arrow follow reading direction, not physical direction -- per the
// WAI-ARIA tabs pattern, they swap under RTL so "next" still means "the tab in
// front of this one," wherever that visually sits.
