...
<template>
  <div class="flex gap-1 overflow-x-auto border-b border-border-light" role="tablist" :aria-label="t('administration.adminDocumentsPage.tabsAriaLabel')">
    <button
