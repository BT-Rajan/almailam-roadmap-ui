...
import { Building2, ClipboardCheck, Pencil, RefreshCw, Trash2, User, Workflow } from '@lucide/vue'
  ...
  <div class="flex flex-col gap-4 rounded-xl border border-border-light bg-bg-card p-5 shadow-soft">
    <div class="flex flex-col gap-3 tablet:flex-row tablet:items-start tablet:justify-between">
      ...
      <div class="flex shrink-0 flex-wrap items-center gap-2">
        ...
        <BaseButton variant="secondary" size="sm" :icon="ClipboardCheck" class="no-print" @click="$emit('open-approval-process')">
          Approval Process
        </BaseButton>
