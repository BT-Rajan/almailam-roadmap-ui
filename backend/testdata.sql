...
INSERT INTO projects (project_no, project_name, client_id, service, engineer_id, current_stage, description, scope_client_confirmed_at, progress, start_date, target_date, status) VALUES
('2600001', 'Al Reem Residential Tower - Structural Design', @c_alreem, 'Structural Engineering', @u_layla, 'Requirement', 'Structural design and analysis for a 12-storey residential tower, covering foundation, superstructure, and seismic assessment.', NULL, 0, '2026-08-01', '2027-02-15', 'Active'),
('2600002', 'Al Reem Tower - MEP Coordination',              @c_alreem, 'MEP Design',             @u_ahmed, 'Quotation',   'MEP coordination and shop-drawing review for the residential tower.', '2026-07-12 10:00:00', 0, '2026-07-10', '2026-12-20', 'Active'),
('2600003', 'Al Reem Annex Building',                        @c_alreem, 'Structural Engineering', @u_layla, 'Payment Plan','Structural design for a new annex building adjoining the main tower.', '2026-06-16 09:30:00', 0, '2026-06-15', '2027-01-10', 'Active'),
('2600004', 'Al Reem Parking Structure',                     @c_alreem, 'Structural Engineering', @u_layla, 'Contract',    'Structural design of a multi-level parking structure for the development.', '2026-05-21 09:00:00', 0,    '2026-05-20', '2026-12-01', 'Active');
...
INSERT INTO projects (project_no, project_name, client_id, service, engineer_id, current_stage, description, scope_client_confirmed_at, progress, start_date, target_date, status) VALUES
('2600005', 'Falcon Heights Warehouse Expansion',       @c_falcon, 'MEP Design',                       @u_ahmed, 'Design',                'MEP design for the warehouse expansion, covering concept through construction-issue drawings.', '2026-05-15 09:00:00', 19,   '2026-05-14', '2026-11-30', 'Active'),
('2600006', 'Falcon Heights Cold Storage Unit - Permits', @c_falcon, 'Government Submission Services',  @u_ahmed, 'Government Submission', 'Municipality and fire authority permitting for a new cold storage unit.',                         '2026-04-02 09:00:00', 10,   '2026-04-01', '2026-10-15', 'Active'),
('2600007', 'Falcon Heights Rooftop Solar Retrofit',     @c_falcon, 'Supervision Services',             @u_ahmed, 'Supervision',            'Ongoing site supervision for a rooftop solar retrofit.',                                          '2026-03-02 09:00:00', 15, '2026-03-01', '2026-09-30', 'Active'),
('2600008', 'Falcon Heights Loading Dock Upgrade',       @c_falcon, 'MEP Design',                       @u_ahmed, 'Design',                'MEP design and permitting for a loading dock capacity upgrade -- electrical layout scope was later descoped.', '2026-02-16 09:00:00', 25, '2026-02-15', '2026-08-30', 'Active');
...
INSERT INTO projects (project_no, project_name, client_id, service, engineer_id, current_stage, description, scope_client_confirmed_at, progress, start_date, target_date, status, supervision_start_date, supervision_end_date, supervision_monthly_total, handover_sent_at, handover_payment_confirmed_at, handover_payment_confirmed_by) VALUES
('2600009', 'Marina Bay Hotel Renovation',   @c_marina, 'Architectural Design', @u_layla, 'Design',      'Full architectural renovation design and site supervision for Marina Bay Hotel, including interior scope.', '2026-03-11 09:00:00', 34,   '2026-03-10', '2026-10-05', 'Active', '2026-04-11', '2026-10-05', 350.00, NULL, NULL, NULL),
('2600010', 'Marina Bay Spa Wing Extension', @c_marina, 'Architectural Design', @u_layla, 'Supervision', 'New spa wing extension: design, building permit, and ongoing site supervision.',                             '2026-04-02 09:00:00', 39,   '2026-04-01', '2026-11-15', 'Active', '2026-06-01', '2027-02-01', 190.00, NULL, NULL, NULL),
('2600011', 'Marina Bay Banquet Hall Refurb',@c_marina, 'Architectural Design', @u_layla, 'Handover',    'Renovation design for the banquet hall -- design complete, awaiting payment confirmation before final hand-over.', '2026-01-16 09:00:00', 90, '2026-01-15', '2026-07-30', 'Active', NULL, NULL, NULL, '2026-08-01 09:00:00', NULL, NULL),
('2600012', 'Marina Bay Rooftop Lounge',     @c_marina, 'Architectural Design', @u_layla, 'Handover',    'Design and building permit for a new rooftop lounge -- payment confirmed, awaiting the client''s signed hand-over acknowledgment.', '2025-12-02 09:00:00', 90, '2025-12-01', '2026-06-15', 'Active', NULL, NULL, NULL, '2026-05-10 09:00:00', '2026-05-15 14:00:00', @u_admin);
...
INSERT INTO projects (project_no, project_name, client_id, service, engineer_id, current_stage, description, scope_client_confirmed_at, progress, start_date, target_date, status) VALUES
('2600013', 'Ahmadi Industrial Facility - Fire Safety Approval', @c_ahmadi, 'Fire & Safety Engineering', @u_ahmed, 'Government Submission', 'Fire suppression system design and Kuwait Fire Service Directorate permitting for the industrial facility.', '2026-01-21 09:00:00', 20,   '2026-01-20', '2026-08-15', 'Active'),
...
('2600015', 'Ahmadi Plant Expansion',                            @c_ahmadi, 'Fire & Safety Engineering', @u_ahmed, 'Design',                'Plant expansion layout and fire safety systems design -- on hold pending client budget approval.',           '2026-02-02 09:00:00', 40, '2026-02-01', '2026-09-01', 'On Hold'),
('2600016', 'Ahmadi Admin Building Refurbishment',               @c_ahmadi, 'Fire & Safety Engineering', @u_ahmed, 'Design',                'Fire exit redesign for the administration building.',                                                          '2026-01-06 09:00:00', 10, '2026-01-05', '2026-07-01', 'Active');
...
INSERT INTO projects (project_no, project_name, client_id, service, engineer_id, current_stage, description, scope_client_confirmed_at, progress, start_date, target_date, status, handover_sent_at, handover_payment_confirmed_at, handover_payment_confirmed_by, handover_acknowledged_at) VALUES
('2600017', 'Desert Rose Retail Plaza - Final Handover',   @c_khalid, 'Civil Engineering', @u_ahmed, 'Handover',    'Civil engineering design and final hand-over for the Desert Rose retail plaza.', '2025-09-03 09:00:00', 100, '2025-09-01', '2026-03-20', 'Completed', '2026-03-18 09:00:00', '2026-03-16 10:00:00', @u_admin, '2026-03-20 11:00:00'),
('2600018', 'Khalid Villa Renovation',                      @c_khalid, 'Architectural Design', @u_layla, 'Requirement', NULL, NULL, 0, '2026-08-20', '2027-03-01', 'Active', NULL, NULL, NULL, NULL),
('2600019', 'Khalid Al Mansoori Residence - Landscape Design', @c_khalid, 'Landscape Design', @u_ahmed, 'Quotation', 'Landscape design for the residence''s front and rear garden.', '2026-07-03 09:00:00', 0, '2026-07-01', '2026-12-15', 'Active', NULL, NULL, NULL, NULL),
('2600020', 'Khalid Guest House Addition',                  @c_khalid, 'Civil Engineering', @u_layla, 'Requirement', 'Proposed guest house addition -- cancelled before a scope was finalised.', NULL, 0, '2026-06-01', '2026-11-01', 'Cancelled', NULL, NULL, NULL, NULL);
